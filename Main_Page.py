...
def end(cid, checkin, checkout, total_price,discounted_price):
    ...
    row_employee = DatabaseManager.getEmployeeDetailsByAadhar(row_customer[1])
    ...
    if row_employee:
        st.write("---")
        st.info('Employee Details:')
        st.write(f'Employee ID: {row_employee[0]}')
        st.write(f'Employee Name: {row_employee[2]}')
        st.write(f'Employee Age: {row_employee[3]}')
        st.write(f'Employee Gender: {row_employee[4]}')
        st.write(f'Employee Role: {row_employee[5]}')
        st.write(f'Employee Salary: {row_employee[6]}')
